...
@Slf4j
@Component
public class SectionSplittingStage implements Stage<Long, List<SectionDto>> {

    @Autowired
    private final SectionService sectionService;

    private final List <String> sectionsList = new ArrayList<>();
    public SectionSplittingStage(SectionService sectionService) {
    ...
    @Override
    public List<SectionDto> process(Long resumeId) {
